...
export interface LitigateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "backendAddress"
      | "backendVault"
...
export interface Litigate extends BaseContract {
  connect(runner?: ContractRunner | null): Litigate;
  waitForDeployment(): Promise<this>;

  interface: LitigateInterface;
